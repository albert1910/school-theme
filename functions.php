<?php
/**
 * Yafeng functions and definitions
 *
...
function yafeng_setup() {
	/*
		...
		* If you're building a theme based on Yafeng, use a find and replace
		* to change 'yafeng' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'yafeng' ),
		)
	);
...
function yafeng_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'yafeng_content_width', 640 );
}
...
function yafeng_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'yafeng' ),
			'id'            => 'sidebar-1',
...
function yafeng_scripts() {
	...
	wp_enqueue_script( 'yafeng-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
